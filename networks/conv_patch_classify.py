...
# train conv_patch model on folio_8_bit_extended_5x5.csv
...
# save log df
log_df.to_pickle(f'{log_path}/conv_patch_loss_acc_log.pkl')
...
# save model
torch.save(model.state_dict(), f'{model_path}/conv_patch_on_{data_class}.pth')
